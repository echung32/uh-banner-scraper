 ...
 * demand — Tier A full sync + Tier B1 diff-driven details + rolling Tier B2.
 * The hourly RefreshWorkflow runs the same refreshMutableTerms() on the Worker;
 * this route is the manual / e2e entry point.
 *
